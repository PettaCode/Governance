...
<div  class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title"><?= __d('system', 'Aadhar Information'); ?></h3>
    </div>
    ...
    <div class="box-body">
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="name"><?= __d('system', 'Aadhar Number'); ?> <font color='#CC0000'>*</font></label>
                <div class="col-sm-8">
                    <input name="account_name" id="account_name" type="text" class="form-control" value="" placeholder="<?= __d('system', 'Aadhar Number'); ?>">
                </div>
            </div>
            <div class="clearfix"></div>
            <br>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="name"><?= __d('system', 'Aadhar Name'); ?> <font color='#CC0000'>*</font></label>
                <div class="col-sm-8">
                    <input name="postal_address_1" id="postal_address_1" type="text" class="form-control" value="" placeholder="<?= __d('system', 'Aadhar Name'); ?>">
                </div>
            </div>
            <div class="clearfix"></div>
            <br>
